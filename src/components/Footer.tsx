    ...
    <footer className="bg-coal text-paper">
      <div className="container-wide py-16 lg:py-24">
        <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr]">
          <div>
            <div className="display-xl text-3xl">BUREAU<span className="text-terra">X</span></div>
          ...
          <div className="space-y-2 text-sm">
            ...
            {settings.itemXUrl && (
              <a href={settings.itemXUrl} target="_blank" rel="noopener" className="mt-3 block font-semibold text-terra">
                Item X — магазин ↗
              </a>
            )}
          </div>
