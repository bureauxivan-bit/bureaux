...
/** Shared <html>/<body> shell used by both root layouts ([locale] and
 *  (internal)) — Next.js requires each root layout to render html/body, and
 *  the analytics stack must stay identical between them. */
