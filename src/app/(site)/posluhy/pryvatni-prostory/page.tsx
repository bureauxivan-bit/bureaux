...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/posluhy/pryvatni-prostory' },
};
    ...
    <>
      ...
      <section className="container-wide pt-8 pb-16 lg:pb-24">
        ...
        <p className="mt-8 max-w-2xl text-base leading-relaxed">
          Дизайн приватних просторів у bureau X — квартири, будинки та резиденції з натуральних
          матеріалів і ручної роботи українських майстрів. Повний проєкт під реалізацію — від
          $60/м², мінімальний проєкт — 120 м². Термін — 1,5–3 місяці залежно від площі.
        </p>
